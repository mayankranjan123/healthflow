  ...
  return (
    <div className="flex h-screen bg-slate-50/50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden h-full relative">
        {/* Header */}
        {(!isMobile || (location.pathname !== '/settings' && location.pathname !== '/profile' && location.pathname !== '/reports' && location.pathname !== '/doctors' && !(location.pathname === '/patients' && location.search.includes('patientId=')))) && (
