    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-5">
        ...
        <div className="space-y-1.5 w-full">
          <label htmlFor="staff-mobile" className="text-xs font-bold text-slate-500 uppercase tracking-wider">
            Mobile Number
          </label>
        ...
        <div className="flex items-center gap-2.5 pt-1.5">
          ...
          />
          <label htmlFor="staff-status" className="text-sm text-slate-700 font-semibold cursor-pointer select-none">
